...
| Treasury auction results | Treasury Fiscal Data / qrawatch import | Daily / quarterly | realized offering amounts, settlement dates, bill/coupon/FRN mix, tenor splits | `15`, `19` | appendix active |
...
| Daily cash and debt operations | Daily Treasury Statement, Debt to the Penny | Daily | operating cash balance, debt changes | `15`, `22` | cross-check appendix active |
| Bank and sector holdings | H.8 and Z.1 | Weekly / quarterly | securities, deposits, sectoral Treasury holdings | `01`, `15` | Z.1 appendix active; H.8 still optional |
...
- H.8 for a bank-fragility appendix. Z.1 sector holdings are already published in the sectoral absorber appendix.
